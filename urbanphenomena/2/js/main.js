(function (window, document) {
    ...
    var sectionNames = ['home', 'about-us', 'projects'];
    ...
    window.onpopstate = function(event) {
        var sectionName = event.state === null ? "home" : event.state.section;

        if (sectionName === "project-details") {
            projectInitialize(event.state.project);
        } else {
    ...
    function addHistory(sectionName, projectName) {
    ...
    function homeAddEventListeners(index) {
        ...
        projectDetailsLinks[i].addEventListener("click", function () {
            ...
            addHistory("project-details", projectName);
    ...
    projectsGrid.addEventListener("click", function (event) {
        if (event.target.className === "cell-background") {
